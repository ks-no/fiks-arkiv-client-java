...
import no.ks.fiks.arkiv.v1.arkivmelding.opprett.Avskrivning
import no.ks.fiks.arkiv.v1.arkivstruktur.metadatakatalog.Identifikatorer
...
class AvskrivningBuilder {
    var avskrivningsdato: LocalDate? = null
        private set
    var avskrevetAv: Saksbehandler? = null
        private set
    ...
    fun avskrevetAv(avskrevetAv: Saksbehandler) = apply { this.avskrevetAv = avskrevetAv }
